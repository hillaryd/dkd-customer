...
#     try:
#         doc = frappe.get_doc('DKD Navbar Settings')
#         return {
#             'application_logo': doc.application_logo
#         }
#     except frappe.DoesNotExistError:
#         frappe.throw(_("DKD Navbar Settings document does not exist"))
...
def get_navbar_routes():
    check=frappe.get_single('DKD Navbar Settings')
    user_details = frappe.get_all("DKD Navbar Item", filters={'parent': 'DKD Navbar Settings','enabled':1}, fields=['*'])
    return user_details

...
export default {
  ...
  setup() {
    ...
    const fetchMonthWiseSpending = async () => {
      try {
        const response = await fetch('/api/method/dkd_customer.dkd_customer.api.dashboard.month_wise_spending');
        ...
        console.error('Error fetching month-wise spending:', error);
      }
    };
